...
export async function DELETE(_: NextRequest, props: { params: Promise<{ varId: string }> }) {
  ...
  const r = await fetch(`${api}/orgs/${orgId}/variables/${params.varId}`, { method: 'DELETE', headers: { Authorization: bearer } });
