...
export async function GET(_req: Request, props: { params: Promise<{ manifestId: string }> }) {
  ...
  const res = await fetch(`${api}/orgs/${orgId}/manifests/${params.manifestId}/versions`, { headers: { Authorization: bearer } });
